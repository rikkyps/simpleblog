                        ...
                        {{ csrf_field() }}
                          <div class="row">
                            <div class="form-group col-md-6">
                              {!! Form::text('name', null, ['class' => $errors->has('name') ? 'form-control is-invalid' : 'form-control', 'placeholder' => 'Name', 'required']) !!}
                              @if ($errors->has('name'))
                            ...
                            <div class="form-group col-md-6">
                              {!! Form::email('email', null, ['class' => $errors->has('email') ? 'form-control is-invalid' : 'form-control', 'placeholder' => 'Enter your email', 'required']) !!}
                              @if ($errors->has('email'))
                                <span class="invalid-feedback">
                            ...
                            <div class="form-group col-md-12">
                              {!! Form::textarea('body', null, ['class'=> $errors->has('body') ? 'form-control is-invalid' : 'form-control', 'placeholder' => 'Type your comment', 'required']) !!}
                              @if ($errors->has('body'))
                              <span class="invalid-feedback">
